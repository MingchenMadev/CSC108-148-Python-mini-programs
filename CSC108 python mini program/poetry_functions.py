...
def check_syllables(poem_lines, pattern, word_to_phonemes):
    ...
    for i in range(len(pattern[0])):
        k = clean_up(poem_lines[i]).split()[-1]
        if len(word_to_phonemes[k]) == pattern[0][i]:
...
if __name__ == '__main__':
    ...
    word_to_phonemes = {'NEXT': ['N', 'EH1', 'K', 'S', 'T'],
                        ...
                        'BEFORE': ['B', 'IH0', 'F', 'AO1', 'R'],
                         ...
                         'POEM': ['P', 'OW1', 'AH0', 'M'],
                         'OFF': ['AO1', 'F']}
    print check_syllables(poem_lines, pattern, word_to_phonemes)
    ...
    word_to_phonemes = {'NEXT': ['N', 'EH1', 'K', 'S', 'T'],
                     ...
                     'POEM': ['P', 'OW1', 'AH0', 'M'],
                        'OFF': ['AO1', 'F']}
    print check_rhyme_scheme(poem_lines, pattern, word_to_phonemes)
